...
var CloudinaryImage = (function (_Component) {
  ...
  CloudinaryImage.prototype.render = function render() {
    ...
    return _reactNative2['default'].createElement(_reactNative.Image, _extends({}, other, { source: { uri: cloudinary.url(publicId, options) } }));
  };

  _createClass(CloudinaryImage, null, [{
    key: 'propTypes',
    value: {
      publicId: _reactNative.PropTypes.string.isRequired,
      options: _reactNative.PropTypes.object
    },
    enumerable: true
  }]);
